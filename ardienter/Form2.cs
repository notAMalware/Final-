...
namespace ardienter
{
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                purchasedItems.Add(item.ToString());
            }

            // Get total cost and discount
            int discount = int.Parse(textBox5.Text.Replace("%", "").Trim());

            Form3 form3 = new Form3(purchasedItems, totalCost, discount);
            form3.Show();
            this.Hide();
        }
    }
